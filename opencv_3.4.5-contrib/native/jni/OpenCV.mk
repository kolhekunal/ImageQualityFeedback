...
OPENCV_MODULES:=stitching superres videostab aruco bgsegm bioinspired ccalib dnn_objdetect dpm face fuzzy hfs img_hash line_descriptor optflow reg rgbd saliency stereo structured_light phase_unwrapping surface_matching tracking datasets text dnn plot xfeatures2d shape video ml ximgproc xobjdetect objdetect calib3d features2d highgui videoio imgcodecs flann xphoto photo imgproc core
